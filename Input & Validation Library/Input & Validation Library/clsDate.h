...
public:
    ...
    static enCompResult GetDatesCompareResult(clsDate Date, clsDate Date2)    {
        return AreDatesEqual(Date,Date2) ? enCompResult::Equla : (IsDate1BeforeDate2(Date,Date2) ? enCompResult::Before : enCompResult::After);
    }
    ...
    short GetVacationDaysNumber(clsDate DateTo)
    {
        ...
        while (IsDate1BeforeDate2(*this, DateTo))
        {
